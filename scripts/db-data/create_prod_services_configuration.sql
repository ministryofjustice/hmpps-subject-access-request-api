...
VALUES
    ...
    ('hmpps-jobs-board-api', 'Match Jobs and Manage Applications', 'https://jobs-board-api.hmpps.service.justice.gov.uk', 29),
    ('hmpps-support-additional-needs-api', 'Support for Additional Needs', 'https://support-for-additional-needs-api.hmpps.service.justice.gov.uk', 30)
