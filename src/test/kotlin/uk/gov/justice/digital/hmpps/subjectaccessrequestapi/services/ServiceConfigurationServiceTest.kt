...
class ServiceConfigurationServiceTest {
  ...
  private val s2 = ServiceConfiguration(serviceName = "service2", label = "Service One", url = "s1.com", order = 2, enabled = true)
  private val s3 = ServiceConfiguration(serviceName = "service3", label = "Service One", url = "s1.com", order = 3, enabled = true)
