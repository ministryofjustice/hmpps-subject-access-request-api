...
class UpdatePrisonUserNameDataTest {

  private val userDetailsRepository: UserDetailsRepository = mock()
  private val userDetailsClient: UserDetailsClient = mock()

  private val updatePrisonUserNameDataService = UpdatePrisonUserNameDataService(userDetailsRepository, userDetailsClient)
  ...
  fun `should update User name data`() {
    ...
    updatePrisonUserNameDataService.updatePrisonUserData()
